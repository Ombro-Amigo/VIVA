				...
				<View style={styles.centeredView}>
					<View style={styles.modalView}>
						...
						<Text style={styles.title}>
							ESCOLHA O PERIÓDO DE VISUALIZAÇÃO DE CONSULTAS
						</Text>
						<View style={styles.areaEscolha}>
							<TouchableOpacity
								onPress={() => {
									setModalVisible(!modalVisible), setRangeConsultas(1);
								}}
							>
							...
							<TouchableOpacity
								onPress={() => {
									setModalVisible(!modalVisible), setRangeConsultas(2);
								}}
							>
							...
							<TouchableOpacity
								onPress={() => {
									setModalVisible(!modalVisible), setRangeConsultas(3);
								}}
							>
							...
							<TouchableOpacity
								onPress={() => {
									setModalVisible(!modalVisible), setRangeConsultas(4);
								}}
							>
							...
							<TouchableOpacity
								onPress={() => {
									setModalVisible(!modalVisible), setRangeConsultas(5);
								}}
							>
