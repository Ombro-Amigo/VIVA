				...
				<View style={styles.centeredView}>
					<View style={styles.modalView}>
						...
						<Text style={styles.title}>
							DEFINA SEU STATUS DE DISPONIBILIDADE
						</Text>
						<View style={styles.areaEscolha}>
							<TouchableOpacity
								onPress={() => {
									setModalVisible(!modalVisible), setDispo(1);
								}}
							>
							...
							<TouchableOpacity
								onPress={() => {
									setModalVisible(!modalVisible), setDispo(2);
								}}
							>
							...
							<TouchableOpacity
								onPress={() => {
									setModalVisible(!modalVisible), setDispo(3);
								}}
							>
